...
- **Cuentas** — crea cuentas en distintas monedas (DOP, USD, …) con su color, y consulta el balance de cada una.
- **Transacciones** — registra ingresos y egresos, con filtros por tipo, cuenta y rango de fechas.
...
- **Dashboard** — totales de ingresos/egresos, balance por cuenta, gráfico de ingresos vs egresos y distribución de gastos, con períodos de semana/mes/año.
